%{
    ...
    2) ...
    3) ...
    4) Auto-search to optimize precision after a starting good point found with eq_current_levmag.m
    5) Repeat 1-4 with approximationType = 1 and XXX_steps = 32 to reduce computation time
%}
...
if(approximationType == 0)
    last_curr = results.neo_vs_lev.curr_fst;
else
    last_curr = results.neo_vs_lev.curr_acc;
end
...
if(approximationType == 0)
    results.neo_vs_lev.curr_fst = best_curr;
else
    results.neo_vs_lev.curr_acc = best_curr;
end
